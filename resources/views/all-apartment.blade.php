...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-semibold text-black-800 mb-6">Tous nos Appartements</h1>
        ...
        <a href="#"
           class="block rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out bg-white cursor-pointer">
            ...
            <div class="p-4">
                ...
                <p class="text-sm text-gray-600 mb-2">Appartement charmant et lumineux, idéalement situé à proximité des
        ...
        <a href="#"
           class="block rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out bg-white cursor-pointer">
            ...
            <div class="p-4">
                ...
                <p class="text-sm text-gray-600 mb-2">Spacieux loft au design industriel, parfait pour les séjours en
                    groupe.</p>
        ...
        <a href="#"
           class="block rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out bg-white cursor-pointer">
            ...
            <div class="p-4">
                ...
                <p class="text-sm text-gray-600 mb-2">Appartement au design contemporain, idéal pour un séjour urbain et
                    dynamique.</p>
        ...
        <a href="#"
           class="block rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out bg-white cursor-pointer">
            ...
            <div class="p-4">
                ...
                <p class="text-sm text-gray-600 mb-2">Superbe penthouse offrant une vue à 360 degrés sur la ville.</p>
